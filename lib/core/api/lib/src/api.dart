...
import 'package:openapi/src/api/bitacora_api.dart';
...
class Openapi {
  ...
  /// Get BitacoraApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BitacoraApi getBitacoraApi() {
    return BitacoraApi(dio, serializers);
  }
